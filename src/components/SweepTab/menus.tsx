...
export function dataMenuItems(
  ...
  const items: MenuProps["items"] = [
    { key: "add-before", label: "在上方插入一行", icon: <PlusOutlined />,
      onClick: () => { ops.addRow(sweepId, gi, ri - 1); close(); } },
    { key: "add-after", label: "在下方插入一行", icon: <PlusOutlined />,
